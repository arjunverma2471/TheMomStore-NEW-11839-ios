//
//  ProductRecommendedViewCell.swift
...
import Foundation
import UIKit
class ProductRecommendedViewCell : UICollectionViewCell {
    
    var headingColor    = UIColor(light: UIColor(hexString: "#050505"),dark: UIColor.provideColor(type: .productVC).textColor)
    var subHeadingColor = UIColor(light: UIColor(hexString: "#050505"),dark: UIColor.provideColor(type: .productVC).textColor)
...
//        let height = self.bounds.height
        let height = (self.bounds.width / 130.0) * 174.0
...
//        addSubview(productHeading)
       ...
       // addSubview(addToCartButton)
        ...
        productImage.anchor(top: outerView.topAnchor, left: leadingAnchor,right: trailingAnchor, paddingTop: 0.2, paddingLeft: 0.2, paddingRight: 0.2, height :height)

        
        productSubHeading.anchor(top: productImage.bottomAnchor, left: leadingAnchor, right: trailingAnchor, paddingTop: 4, paddingLeft: 4, paddingRight: 4)
        
//        productHeading.anchor(top: productSubHeading.bottomAnchor, left: leadingAnchor, right: trailingAnchor, paddingTop: 0, paddingLeft: 4, paddingRight: 4)
        
        productPrice.anchor(top: productSubHeading.bottomAnchor, left: leadingAnchor, bottom: outerView.bottomAnchor, right: trailingAnchor, paddingTop: 4, paddingLeft: 4, paddingBottom: 8, paddingRight: 4)
...
//        productHeading.text = model.vendor
    ...
    func calculatePrice(model:ProductViewModel) -> NSMutableAttributedString {
        ...
        let priceAttr = [NSAttributedString.Key.foregroundColor:UIColor(light: UIColor.black,dark: UIColor.provideColor(type: .productVC).textColor),NSAttributedString.Key.font:mageFont.mediumFont(size: 14.0)]
...
//            finalString.append(offerString)
            ...
            let attr = [NSAttributedString.Key.foregroundColor:UIColor(light: .darkGray,dark: UIColor.provideColor(type: .productVC).textColor),NSAttributedString.Key.font:mageFont.mediumFont(size: 14.0)]
