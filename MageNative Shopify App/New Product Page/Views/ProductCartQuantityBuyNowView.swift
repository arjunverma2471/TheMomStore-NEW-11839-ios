//
//  ProductCartQuantityBuyNowView.swift
//  MageNative Shopify App
//
//  Created by cedcoss on 11/07/22.
//  Copyright © 2022 MageNative. All rights reserved.
//

import Foundation
import UIKit
class ProductCartQuantityBuyNowView : UIView , UITextFieldDelegate {
    ...
    func initView() {
        ...
        buyNow.anchor(top: collectionView.bottomAnchor, left: mainView.leadingAnchor, bottom: mainView.bottomAnchor, right: mainView.trailingAnchor, paddingTop: 8, paddingLeft: 16, paddingBottom: 8, paddingRight: 16, height: 45)
        
    }
    
}
extension ProductCartQuantityBuyNowView : UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        print("indexPath----->",indexPath.row, quantityArray.count)
