//
//  wishlistProductShimmerTC.swift
...
class wishlistProductShimmerTC: UITableViewCell {
    
    static let reuseID = "wishlistProductShimmerTC"
    ...
    func configUI(){
        addSubview(prdImage)
        prdImage.anchor(left: leadingAnchor, paddingLeft: 0, width: 100, height: 100)
        prdImage.centerY(inView: self)
