...
class PreviewThemesController : UIViewController {
    ...
    lazy var headerTitle : UILabel = {
        ...
        label.textColor = UIColor(light: .AppTheme(), dark:  .white)
        return label
    }()
    ...
    private lazy var dropDownButton : UIButton = {
        let button = UIButton()
        button.setTitle("All Store".localized, for: .normal)
    ...
    var dataSource = ["Default".localized,"Grocery".localized,"Home Decor".localized,"Fashion".localized]
    
    var themesData = ["Default".localized,"Grocery".localized,"Home Decor".localized,"Fashion".localized]
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.setupView()
     /*   let titleWidth = ("Theme Designs".localized as NSString).size(withAttributes: [NSAttributedString.Key.font: mageFont.mediumFont(size: 16)]).width
        let title = UILabel(frame: CGRect(x: 0, y: 0, width: titleWidth, height: 30))
        title.font = mageFont.mediumFont(size: 16)
        title.text = "Theme Designs".localized
...
extension PreviewThemesController : UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if themeName == "Default".localized {
        ...
        else if themeName == "Home Decor".localized{
            ...
            UserDefaults.standard.setValue(themeName, forKey: "themeSelected")
            (UIApplication.shared.delegate as! AppDelegate).loadHomepage()
        }
        else if themeName == "Fashion".localized{
        ...
        else if themeName == "Grocery".localized{
